...
public:
    ...
    void addBooking(); // Add a booking to the building
    ...
    vector<Booking> bookingListFiltered(int, int, double, double); // returns a new Vector containing all the filtered Bookings.
...
public:
    ...
    Booking(int, int, double, double); // Overloaded constructor to set up a booking object with all required properties
};
